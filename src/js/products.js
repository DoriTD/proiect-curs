module.exports = {
  categories: ["Chairs", "Couches", "Beds", "Lights", "Tables", "Plants"],
  brands: ["Amado", "IKEA", "Mobexpert", "Vivre"],
  products: [
    {
      name: "Woodden Chair",
      imageUrl:
    ...
    },
    {
      name: "Green Ficus",
      imageUrl:
        "https://images.unsplash.com/photo-1491147334573-44cbb4602074?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60",
      price: 60,
      category: "Plants",
      brand: "Amado",
      description:
    ...
    },
    {
      name: "Suculent plant",
      imageUrl:
        "https://images.unsplash.com/photo-1446071103084-c257b5f70672?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60",
      price: 70,
      category: "Plants",
      brand: "IKEA",
      description:
    ...
    {
      name: "Mettalic Lights",
      imageUrl:
        "https://images.unsplash.com/photo-1482350325005-eda5e677279b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60",
      price: 150,
      category: "Lights",
      brand: "IKEA",
      description:
